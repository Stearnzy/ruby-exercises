...
class EnumerablesTest < Minitest::Test
  ...
  def test_smallest_number
    ...
    actual = numbers.min_by { |num| num.digits.count }
  ...
  def test_most_programmers
    ...
    actual = programmers.max_by do |lang, people|
      people.count
    end
  ...
  def test_multiply_list_of_numbers
    ...
    numbers = [2, 3, 5, 7]
    # initial value is 1
    actual = numbers.reduce(1) do |product, number|
      product * number
    end
  ...
  def test_all_multiples_of_7
    ...
    actual = numbers.all? { |number| number % 7 == 0 }
    assert actual
  end
  ...
  def test_remove_hashes
    ...
    actual = elements.reject { |element| element.is_a? Hash }
  ...
  def test_capitalize_keywords_in_phrase_one_fish_two_fish_red_fish_blue_fish
    ...
    actual = keywords.reduce("one fish two fish red fish blue fish") do |phrase, keyword|
  ...
  def test_subtract_smallest_values_from_100
    ...
    actual = elements.reduce(100) do |subract, element|
      subract - element.min
    end
